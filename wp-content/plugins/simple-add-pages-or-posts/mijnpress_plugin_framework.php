...
class mijnpress_plugin_framework
{
    ...
    var $all_plugins = array('Admin renamer extended','Antispam for all fields','Mass Delete Tags','Auto Prune Posts','Warm cache','See attachments','Automatic Comment Scheduler','Subscribe2 widget','Define Constants','Mass Delete Unused Tags','Prevent core update','WPML flag in menu');
